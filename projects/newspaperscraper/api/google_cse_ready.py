    ...
    def search(self, query: str, start: int = 1, num: int = 10) -> Dict:
        ...
        try:
            params = {
                ...
                'fields': 'items(title,link,snippet,displayLink,htmlTitle,htmlSnippet)',  # Only get needed fields
            }
...
def demonstration_mode():
    ...
    print("🔗 Example URLs:")
    test_queries = ["shellharbour council", "wollongong news", "illawarra events"]
...
def api_key_mode(api_key: str):
    ...
    if test_result['success']:
        ...
        print(f"   Results found for test query: {test_result['results_found']}")
        print()
