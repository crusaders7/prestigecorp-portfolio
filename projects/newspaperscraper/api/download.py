    ...
    def do_POST(self):
        try:
            ...
            if not articles or not isinstance(articles, list):
                self.send_error_response(400, 'No articles provided or articles not in list format')
                return
            ...
            if file_format == 'zip':
                try:
                    ...
                    with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zip_file:
                        ...
                        for i, article in enumerate(articles):
                            if 'title' in article and 'content' in article:
                                ...
                                article_content += article.get('content', 'No content')
                                zip_file.writestr(article_filename, article_content)
                    ...
                    self.send_error_response(500, f'Failed to create ZIP file: {str(e)}')
                ...
                try:
                    ...
                    self.send_error_response(500, f'Failed to create JSON response: {str(e)}')
