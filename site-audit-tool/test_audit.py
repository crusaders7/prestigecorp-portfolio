...
def test_audit_api(base_url="http://localhost:3000", test_url="https://example.com"):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"  Performance Score: {results.get('performance_score', 0)}/100")
            print(f"  Accessibility Score: {results.get('accessibility_score', 0)}/100")
            ...
            print(f"  {'✅' if valid_scores else '❌'} Score validity: {valid_scores}")
...
def test_error_handling():
    ...
    test_cases = [
        ...
        {"url": "https://this-domain-does-not-exist-12345.com"},  # Non-existent domain
        {},  # Missing URL field
    ]
    ...
    for i, payload in enumerate(test_cases, 1):
        ...
        try:
            ...
            if response.status_code >= 400:
                ...
                print(f"  ⚠️ Unexpected success status: {response.status_code}")
